...
- Нет проверки содержимого файла (антивирус, сигнатуры и т.п.) — это сознательно оставляем за рамками;
...
- **NFR:** NFR-03 (валидация входных данных, включая проверку размера и типа файла).
